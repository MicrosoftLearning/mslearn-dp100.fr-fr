---
lab:
  title: Surveiller un modèle
ms.openlocfilehash: d00816159cd605ad7aad2a275471db18411bce4a
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: fr-FR
ms.lasthandoff: 11/17/2021
ms.locfileid: "145195771"
---
# <a name="monitor-a-model"></a>Surveiller un modèle

Lorsque vous déployez un modèle en tant que service, il est utile de pouvoir suivre les informations relatives aux demandes qu’il traite.

Azure Machine Learning s’intègre avec Azure Application Informations pour vous permettre de journaliser les données des services déployés.
...
## <a name="use-application-insights-to-monitor-a-real-time-service"></a>Utiliser Application Insights pour surveiller un service en temps réel

Dans cet exercice, le code permettant de configurer Application Insights pour un service prédictif déployé est fourni dans un notebook.

1. Dans la page d’accueil Jupyter, accédez au dossier **/users/*votre-nom-utilisateur*/mslearn-dp100** dans lequel vous avez cloné le référentiel de notebooks, puis ouvrez le notebook **Surveiller un modèle**.
