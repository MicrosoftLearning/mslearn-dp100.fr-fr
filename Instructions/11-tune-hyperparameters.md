...
ms.locfileid: "145195796"
---
# <a name="tune-hyperparameters"></a>Ajuster les hyperparamètres
...
Dans cet exercice, vous allez utiliser Azure Machine Learning pour ajuster les hyperparamètres en effectuant plusieurs exécutions d’apprentissage en parallèle.
...
## <a name="run-a-hyperparameter-tuning-experiment"></a>Exécuter une expérience d’ajustement des hyperparamètres.

Dans cet exercice, le code permettant d’exécuter une expérience d’ajustement des hyperparamètres est fourni dans un notebook.

1. Dans la page d’accueil Jupyter, accédez au dossier **/users/*votre-nom-utilisateur*/mslearn-dp100** dans lequel vous avez cloné le référentiel de notebooks, puis ouvrez le notebook **Ajuster les hyperparamètres**.
