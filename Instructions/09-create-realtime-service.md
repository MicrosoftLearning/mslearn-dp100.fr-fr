---
lab:
  title: Créer un service d’inférence en temps réel.
ms.openlocfilehash: ff6fbdd4e17fbb3fdf1c22544d0eefa08dde4959
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: fr-FR
ms.lasthandoff: 11/17/2021
ms.locfileid: "145195770"
---
# <a name="create-a-real-time-inference-service"></a>Créer un pipeline d’inférence en temps réel.

Il est inutile d’effectuer l’apprentissage et d’inscrire des modèles d’apprentissage automatique si vous ne prévoyez pas de les mettre à la disposition des applications. Dans cet exercice, vous allez déployer un modèle en tant que service web pour l’inférence en temps réel.
...
## <a name="create-a-real-time-inferencing-service"></a>Créer un service d’inférence en temps réel

Dans cet exercice, le code permettant de déployer un modèle en tant que service d’inférence en temps réel est fourni dans un notebook.

1. Dans la page d’accueil Jupyter, accédez au dossier **/users/*votre-nom-utilisateur*/mslearn-dp100** dans lequel vous avez cloné le référentiel de notebooks, puis ouvrez le notebook **Créer un service d’inférence en temps réel**.
